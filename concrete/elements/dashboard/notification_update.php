...
<?php echo t('The latest version of concrete5 is <strong>%s</strong>. You are running %s. <a href="%s">Update Now</a>!', $latest_version, APP_VERSION, $this->url('/dashboard/system/maintenance/update'))?>
</div>
